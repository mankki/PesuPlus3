...
const Herosection = () => {
  ...
  return (
    <div className="w-full h-[90vh]" id="hero">
      ...
      <div className="absolute bottom-0 left-0 right-0 top-0 h-[99%] w-full overflow-hidden bg-black bg-fixed opacity-25"></div>
      <div className="absolute top-[10%] left-[50%] translate-x-[-50%] flex flex-col items-baseline mt-6 lg:mt-2 text-white" style={{ textShadow: "2px 2px 6px black" }}>
        <h1 className="text-7xl/[2.5rem] sm:text-8xl lg:text-9xl tracking-wide">PesuPlus</h1>
        ...
        {/* Centered Button and Phone Number */}
        <div className="flex flex-col items-center mt-36">
          <button
            onClick={toggleReservationModalState}
            className="py-3 px-4 rounded-[40px] w-60 border-2 border-white text-white text-center"
            style={{
              fontSize: 'x-large',
          ...
          <p className="mt-2 text-xl">tai soita: 044 243 6843</p>
        </div>
      </div>
